...
def split_to_support_query(train_dir, test_dir, p):
    ...
    # 统计相关的信息
    print('拆分之前:')
    print_stats(data=before_merged, max_class_num=2)
    print('训练:')
    print_stats(data=f_train_data, max_class_num=2)
    print('测试:')
    print_stats(data=f_test_data, max_class_num=2)
