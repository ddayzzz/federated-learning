...
DATASET_FILE = cpath + '/data'
IMAGE_DATA = False  # 扁平化, 且转换为浮点
np.random.seed(6)
...
def main():
    ...
    train_mnist = ImageDataset(trainset.train_data, trainset.train_labels, normalize=True)
    test_mnist = ImageDataset(testset.test_data, testset.test_labels, normalize=True)
    ...
    train_path = '{}/data/train/all_data_{}_random_niid_user[100].pkl'.format(cpath, image)
    test_path = '{}/data/test/all_data_{}_random_niid_user[100].pkl'.format(cpath, image)
