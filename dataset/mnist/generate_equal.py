...
class ImageDataset(object):
    ...
    def __init__(self, images, labels, normalize=False, flatten=True):
...
def main():
    ...
    train_mnist = ImageDataset(trainset.train_data, trainset.train_labels, normalize=True, flatten=True)
    test_mnist = ImageDataset(testset.test_data, testset.test_labels, normalize=True, flatten=True)
    ...
    train_path = '{}/data/train/all_data_{}_equal_niid_user[100].pkl'.format(cpath, image)
    test_path = '{}/data/test/all_data_{}_equal_niid_user[100].pkl'.format(cpath, image)
    ...
    print('>>> User training data distribution: {}'.format(train_data['num_samples']))
    print('>>> User testing data distribution: {}'.format(test_data['num_samples']))
